...
- Runway photo → About page portrait, or Media section (Phase 6 of `_four` built an inert media section; `_one` is the active repo).
- Videos → Media section only after Eman confirms content and consent to publish.
- Add `alt` text written with Eman; the site is WCAG 2.2 AA and every image needs real alt.

## Before anything goes public

1. Eman confirms she wants these on the site and who took the photo.
2. Get higher-resolution originals if they exist; 176×144 video will not scale.
3. Remove the gallery badge/border from the screenshot.
