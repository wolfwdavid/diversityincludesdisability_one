...
export const WEB3FORMS_ACCESS_KEY = 'YOUR_WEB3FORMS_ACCESS_KEY'; // TODO(user): generate at https://web3forms.com with diversityincludesdisability@gmail.com (org address per Eman 2026-09-24); key is emailed to that inbox
