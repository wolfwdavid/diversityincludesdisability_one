...
- [x] **THEME-01**: Visitor can toggle between a Premium theme and an Accessible theme from any page
...
- [x] **THEME-06**: The theme toggle is keyboard-operable, announced to assistive tech, and preserves focus on switch
